...
!function(Q, X, w) {
    function I(b) {
        return function() {
            var c, a = arguments[0];
            for (c = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.4.7/" + (b ? b + "/" : "") + a, 
    ...
    function Da(b) {
        ...
        return b.nodeType === pa && a ? !0 : G(b) || J(b) || 0 === a || "number" == typeof a && a > 0 && a - 1 in b;
    }
    function m(b, a, c) {
        var d, e;
        ...
        } else if (b.forEach && b.forEach !== m) b.forEach(a, c, b); else if (mc(b)) for (d in b) a.call(c, b[d], d, b); else if ("function" == typeof b.hasOwnProperty) for (d in b) b.hasOwnProperty(d) && a.call(c, b[d], d, b); else for (d in b) ta.call(b, d) && a.call(c, b[d], d, b);
        return b;
    }
    function nc(b, a, c) {
    ...
    function Mb(b, a, c) {
        for (var d = b.$$hashKey, e = 0, f = a.length; f > e; ++e) {
            var h = a[e];
            if (C(h) || x(h)) for (var g = Object.keys(h), l = 0, k = g.length; k > l; l++) {
                var n = g[l], p = h[n];
                c && C(p) ? ea(p) ? b[n] = new Date(p.valueOf()) : Oa(p) ? b[n] = new RegExp(p) : (C(b[n]) || (b[n] = J(p) ? [] : {}), 
                Mb(b[n], [ p ], !0)) : b[n] = p;
            }
        }
        return pc(b, d), b;
    ...
    function ha(b, a, c, d) {
        ...
        if (a) {
            if (b === a) throw Ea("cpi");
            c = c || [], d = d || [], C(b) && (c.push(b), d.push(a));
            var e;
            if (J(b)) for (e = a.length = 0; e < b.length; e++) a.push(ha(b[e], null, c, d)); else {
                var f = a.$$hashKey;
                if (J(a) ? a.length = 0 : m(a, function(b, c) {
                    delete a[c];
                }), mc(b)) for (e in b) a[e] = ha(b[e], null, c, d); else if (b && "function" == typeof b.hasOwnProperty) for (e in b) b.hasOwnProperty(e) && (a[e] = ha(b[e], null, c, d)); else for (e in b) ta.call(b, e) && (a[e] = ha(b[e], null, c, d));
                pc(a, f);
            }
        } else if (a = b, C(b)) {
            ...
            a.lastIndex = b.lastIndex; else {
                if (!x(b.cloneNode)) return e = Object.create(rc(b)), ha(b, e, c, d);
                a = b.cloneNode(!0);
            }
            d && (c.push(b), d.push(a));
        }
    ...
    function Xd(b, a) {
        var c = a;
        return "string" == typeof b && "$" === b.charAt(0) && "$" === b.charAt(1) ? c = w : Za(a) ? c = "$WINDOW" : a && X === a ? c = "$DOCUMENT" : ab(a) && (c = "$SCOPE"), 
        c;
    }
    function eb(b, a) {
        return "undefined" == typeof b ? w : (V(a) || (a = a ? 2 : null), JSON.stringify(b, Xd, a));
    }
    function vc(b) {
    ...
    function yc(b) {
        ...
        return m((b || "").split("&"), function(b) {
            ...
            f = b.substring(d + 1)), e = xc(e), A(e) && (f = A(f) ? xc(f) : !0, ta.call(a, e) ? J(a[e]) ? a[e].push(f) : a[e] = [ a[e], f ] : a[e] = f));
        }), a;
    }
    function Pb(b) {
        var a = [];
    ...
    function Yd(b, a) {
        var c, d, e = Qa.length;
        for (d = 0; e > d; ++d) if (c = Qa[d] + a, G(c = b.getAttribute(c))) return c;
        return null;
    }
    function Zd(b, a) {
        var c, d, e = {};
    ...
    function zc(b, a, c) {
        ...
        return Q && e.test(Q.name) && (c.debugInfoEnabled = !0, Q.name = Q.name.replace(e, "")), 
        Q && !f.test(Q.name) ? d() : (Q.name = Q.name.replace(f, ""), da.resumeBootstrap = function(b) {
            return m(b, function(b) {
                a.push(b);
            }), d();
        }, void (x(da.resumeDeferredBootstrap) && da.resumeDeferredBootstrap()));
    }
    function $d() {
        Q.name = "NG_ENABLE_DEBUG_INFO!" + Q.name, Q.location.reload();
    }
    function ae(b) {
        if (b = da.element(b).injector(), !b) throw Ea("test");
    ...
    function ce() {
        ...
        if (!Bc) {
            ...
            (ra = v(a) ? Q.jQuery : a ? Q[a] : w) && ra.fn.on ? (B = ra, P(ra.fn, {
                ...
                var d;
                if (Qb) Qb = !1; else for (var f, e = 0; null != (f = a[e]); e++) (d = ra._data(f, "events")) && d.$destroy && ra(f).triggerHandler("$destroy");
                b(a);
    ...
    function Sa(b, a, c) {
        return c && J(b) && (b = b[b.length - 1]), qb(x(b), a, "not a function, got " + (b && "object" == typeof b ? b.constructor.name || "Object" : typeof b)), 
        b;
    }
    function Ta(b, a) {
    ...
    function rb(b) {
        for (var d, a = b[0], c = b[b.length - 1], e = 1; a !== c && (a = a.nextSibling); e++) (d || b[e] !== a) && (d || (d = B(ua.call(b, 0, e))), 
        d.push(a));
        return d || b;
    }
    function fa() {
    ...
    function de(b) {
        ...
        return b = a(b, "angular", Object), b.$$minErr = b.$$minErr || I, a(b, "module", function() {
            var b = {};
            return function(f, h, g) {
                if ("hasOwnProperty" === f) throw d("badname", "module");
                return h && b.hasOwnProperty(f) && (b[f] = null), a(b, f, function() {
                    function a(b, c, e, f) {
    ...
    function ee(b) {
        ...
        }), (Rb = de(Q))("ng", [ "ngLocale" ], [ "$provide", function(a) {
            a.provider({
                $$sanitizeUri: ge
                ...
                ngInclude: Pe
            }).directive(tb).directive(Jc), a.provider({
                $anchorScroll: Qe,
                $animate: Re,
                $animateCss: Se,
                $$animateQueue: Te,
    ...
    function Lc(b) {
        return b = b.nodeType, b === pa || !b || 9 === b;
    }
    function Mc(b, a) {
        var c, d, e = a.createDocumentFragment(), f = [];
        if (Sb.test(b)) {
            for (c = c || e.appendChild(a.createElement("div")), d = (Cf.exec(b) || [ "", "" ])[1].toLowerCase(), 
            d = ma[d] || ma._default, c.innerHTML = d[1] + b.replace(Df, "<$1></$2>") + d[2], 
    ...
    function ub(b, a) {
        if (a || vb(b), b.querySelectorAll) for (var c = b.querySelectorAll("*"), d = 0, e = c.length; e > d; d++) vb(c[d]);
    }
    function Oc(b, a, c, d) {
    ...
    function vb(b, a) {
        ...
        Oc(b)), delete hb[c], b.ng339 = w));
    }
    function wb(b, a) {
        var c = b.ng339, c = c && hb[c];
        return a && !c && (b.ng339 = c = ++Ff, c = hb[c] = {
            events: {},
            data: {},
            handle: w
        }), c;
    ...
    function Vb(b, a, c) {
        if (Lc(b)) {
            ...
            if (b = (b = wb(b, !e)) && b.data, d) b[a] = c; else {
                if (f) return b;
                if (e) return b && b[a];
                P(b, a);
            }
    ...
    function Ab(b, a, c) {
        for (9 == b.nodeType && (b = b.documentElement), a = J(a) ? a : [ a ]; b; ) {
            for (var d = 0, e = a.length; e > d; d++) if (A(c = B.data(b, a[d]))) return c;
    ...
    function Gf(b, a) {
        a = a || Q, "complete" === a.document.readyState ? a.setTimeout(b) : B(a).on("load", b);
    }
    function Rc(b, a) {
    ...
    function Hf(b, a) {
        var c = function(c, e) {
            ...
            if (h) {
                ...
                for (var l = 0; h > l; l++) c.isImmediatePropagationStopped() || f[l].call(b, c);
            }
        };
        return c.elem = b, c;
    }
    ...
    function fb(b, a) {
        function c(a) {
            return function(b, c) {
                return C(b) ? void m(b, oc(a)) : a(b, c);
            };
        }
        function d(a, b) {
        ...
        function h(a) {
            ...
            return m(a, function(a) {
                ...
                if (!n.get(a)) {
                    n.put(a, !0);
                    try {
                        G(a) ? (c = Rb(a), b = b.concat(h(c.requires)).concat(c._runBlocks), d(c._invokeQueue), 
        ...
        function g(b, c) {
            ...
            function e(b, c, f, g) {
                ...
                var l, r, p, h = [], k = fb.$$annotate(b, a, g);
                for (r = 0, l = k.length; l > r; r++) {
                    if (p = k[r], "string" != typeof p) throw Ha("itkn", p);
            ...
            return {
                ...
                instantiate: function(a, b, c) {
                    ...
                    return a = e(a, d, b, c), C(a) || x(a) ? a : d;
                },
                get: d,
        ...
        this.disableAutoScrolling = function() {
            ...
            function f(b) {
                if (b) {
                    b.scrollIntoView();
                    var c;
                    c = h.yOffset, x(c) ? c = c() : sc(c) ? (c = c[0], c = "fixed" !== a.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom) : V(c) || (c = 0), 
    ...
    function Kf(b, a, c, d) {
        ...
        function g() {
            (z !== l.url() || q !== u) && (z = l.url(), q = u, m(O, function(a) {
                a(l.url(), u);
            }));
        }
        ...
        h(), q = u, l.url = function(a, c, e) {
            if (v(e) && (e = null), k !== b.location && (k = b.location), n !== b.history && (n = b.history), 
            a) {
                var f = q === e;
                if (z === a && (!d.history || f)) return l;
                var g = z && Ja(z) === Ja(a);
                return z = a, q = e, !d.history || g && f ? ((!g || ia) && (ia = a), c ? k.replace(a) : g ? (c = k, 
                e = a.indexOf("#"), e = -1 === e ? "" : a.substr(e), c.hash = e) : k.href = a, k.href !== a && (ia = a)) : (n[c ? "replaceState" : "pushState"](e, "", a), 
                h(), q = u), l;
            }
        ...
        l.onUrlChange = function(a) {
            return H || (d.history && B(b).on("popstate", f), B(b).on("hashchange", f), H = !0), 
            O.push(a), a;
    ...
    function Dc(b, a) {
        ...
        this.directive = function r(a, f) {
            return Ta(a, "directive"), G(a) ? (d(a), qb(f, "directiveFactory"), e.hasOwnProperty(a) || (e[a] = [], 
            b.factory(a + "Directive", [ "$injector", "$exceptionHandler", function(b, d) {
                ...
                return m(e[a], function(e, g) {
                    try {
                        ...
                        x(h) ? h = {
                            compile: qa(h)
                        } : !h.compile && h.link && (h.compile = qa(h.link)), h.priority = h.priority || 0, 
                        ...
                        if (C(l.scope) && (!0 === l.bindToController ? (n.bindToController = c(l.scope, r, !0), 
                        n.isolateScope = {}) : n.isolateScope = c(l.scope, r, !1)), C(l.bindToController) && (n.bindToController = c(l.bindToController, r, !0)), 
                        ...
                        var s = k.$$bindings = n;
                        C(s.isolateScope) && (h.$$isolateBindings = s.isolateScope), h.$$moduleName = e.$$moduleName, 
                        f.push(h);
                    } catch (w) {
                        d(w);
                    }
                }), f;
            } ])), e[a].push(f)) : m(a, oc(r)), this;
        ...
        this.debugInfoEnabled = function(a) {
            ...
            function W(a, b, c, d, e) {
                ...
                return function(b, c, d) {
                    ...
                    g || (g = (d = d && d[0]) && "foreignobject" !== wa(d) && d.toString().match(/SVG/) ? "svg" : "html"), 
            ...
            function S(a, b, c, d, e, f) {
                function g(a, c, d, e) {
                    ...
                    for (r = 0, n = h.length; n > r; ) k = O[h[r++]], c = h[r++], f = h[r++], c ? (c.scope ? (l = a.$new(), 
                    W.$$addScopeInfo(B(k), l), (t = c.$$destroyBindings) && (c.$$destroyBindings = null, 
                    l.$on("$destroyed", t))) : l = a, t = c.transcludeOnThisElement ? ba(a, c.transclude, e) : !c.templateOnThisElement && e ? e : !e && b ? ba(a, b) : null, 
                    c(f, l, k, d, t, c)) : f && f(a, k.childNodes, w, e);
                }
                for (var k, l, r, n, q, h = [], t = 0; t < a.length; t++) k = new Z(), l = ca(a[t], [], k, 0 === t ? d : w, e), 
            ...
            function ca(a, b, c, d, e) {
                ...
                switch (a.nodeType) {
                  case pa:
                    na(b, ya(wa(a)), "E", d, e);
                    for (var l, r, n, q = a.attributes, t = 0, O = q && q.length; O > t; t++) {
                        var K = !1, H = !1;
                        l = q[t], k = l.name, r = T(l.value), l = ya(k), (n = ja.test(l)) && (k = k.replace(Wc, "").substr(8).replace(/_(.)/g, function(a, b) {
                            return b.toUpperCase();
                        }));
                        var S = l.replace(/(Start|End)$/, "");
                        I(S) && l === S + "Start" && (K = k, H = k.substr(0, k.length - 5) + "end", k = k.substr(0, k.length - 6)), 
                        l = ya(k.toLowerCase()), g[l] = k, (n || !c.hasOwnProperty(l)) && (c[l] = r, Rc(a, l) && (c[l] = !0)), 
                        V(a, b, r, l, n), na(b, l, "A", d, e, K, H);
                    }
                    if (a = a.className, C(a) && (a = a.animVal), G(a) && "" !== a) for (;k = h.exec(a); ) l = ya(k[2]), 
                    na(b, l, "C", d, e) && (c[l] = T(k[3])), a = a.substr(k.index + k[0].length);
                    break;
                  ...
                  case 8:
                    try {
                        (k = f.exec(a.nodeValue)) && (l = ya(k[1]), na(b, l, "M", d, e) && (c[l] = T(k[2])));
                    } catch (E) {}
                }
                return b.sort(M), b;
            }
            function za(a, b, c) {
                ...
                if (b && a.hasAttribute && a.hasAttribute(b)) {
                    do {
                        ...
                        a.nodeType == pa && (a.hasAttribute(b) && e++, a.hasAttribute(c) && e--), d.push(a), 
                        a = a.nextSibling;
                    } while (e > 0);
                } else d.push(a);
                return B(d);
            ...
            function D(a, b, d, e, f, g, h, k, r) {
                function n(a, b, c, d) {
                    a && (c && (a = s(a, c, d)), a.require = D.require, a.directiveName = y, (u === D || D.$$isolateScope) && (a = $(a, {
                        isolateScope: !0
                    })), h.push(a)), b && (c && (b = s(b, c, d)), b.require = D.require, b.directiveName = y, 
                    (u === D || D.$$isolateScope) && (b = $(b, {
                        isolateScope: !0
                    })), k.push(b));
                }
                function t(a, b, c, d) {
                    ...
                    if (G(b)) {
                        ...
                        e = g ? c.inheritedData(d) : c.data(d)), !e && !f) throw ga("ctreq", b, a);
                    } else if (J(b)) for (e = [], g = 0, f = b.length; f > g; g++) e[g] = t(a, b[g], c, d);
                    return e || null;
                }
                function O(a, b, c, d, e, f) {
                    ...
                    for (h in d) {
                        ...
                        "@" == r && (r = b[k.name]), l = q(r, l, !0, k.controllerAs), g[k.name] = l, ia || a.data("$" + k.name + "Controller", l.instance);
                    }
                    return g;
                }
                function K(a, c, e, f, g, l) {
                    function r(a, b, c) {
                        var d;
                        return ab(a) || (c = b, b = a, a = w), ia && (d = ca), c || (c = ia ? N.parent() : N), 
                        g(a, b, d, c, za);
                    }
                    var n, q, H, E, ca, z, N;
                    if (b === e ? (f = d, N = d.$$element) : (N = B(e), f = new Z(N, d)), u && (E = c.$new(!0)), 
                    g && (z = r, z.$$boundTransclude = g), ba && (ca = O(N, f, z, ba, E, c)), u && (W.$$addScopeInfo(N, E, !0, !(L && (L === u || L === u.$$originalDirective))), 
                    W.$$addScopeClass(N, !0), E.$$isolateBindings = u.$$isolateBindings, Y(c, f, E, E.$$isolateBindings, u, E)), 
                    ca) {
                        var m, Va = u || S;
                        Va && ca[Va.name] && (q = Va.$$bindings.bindToController, (H = ca[Va.name]) && H.identifier && q && (m = H, 
                        l.$$destroyBindings = Y(c, f, H.instance, q, Va)));
                        for (n in ca) {
                            H = ca[n];
                            var D = H();
                            D !== H.instance && (H.instance = D, N.data("$" + n + "Controller", D), H === m && (l.$$destroyBindings(), 
                            l.$$destroyBindings = Y(c, f, D, q, Va)));
                        }
                    }
                    for (n = 0, l = h.length; l > n; n++) q = h[n], aa(q, q.isolateScope ? E : c, N, f, q.require && t(q.directiveName, q.require, N, ca), z);
                    var za = c;
                    for (u && (u.template || null === u.templateUrl) && (za = E), a && a(za, e.childNodes, w, g), 
                    n = k.length - 1; n >= 0; n--) q = k[n], aa(q, q.isolateScope ? E : c, N, f, q.require && t(q.directiveName, q.require, N, ca), z);
                }
                r = r || {};
                for (var D, y, M, na, H = -Number.MAX_VALUE, S = r.newScopeDirective, ba = r.controllerDirectives, u = r.newIsolateScopeDirective, L = r.templateDirective, z = r.nonTlbTranscludeDirective, N = !1, m = !1, ia = r.hasElementTranscludeDirective, v = d.$$element = B(b), Ka = e, I = 0, F = a.length; F > I; I++) {
                    D = a[I];
                    var P = D.$$start, R = D.$$end;
                    if (P && (v = za(b, P, R)), M = w, H > D.priority) break;
                    if ((M = D.scope) && (D.templateUrl || (C(M) ? (Q("new/isolated scope", u || S, D, v), 
                    u = D) : Q("new/isolated scope", u, D, v)), S = S || D), y = D.name, !D.templateUrl && D.controller && (M = D.controller, 
                    ba = ba || fa(), Q("'" + y + "' controller", ba[y], D, v), ba[y] = D), (M = D.transclude) && (N = !0, 
                    D.$$tlb || (Q("transclusion", z, D, v), z = D), "element" == M ? (ia = !0, H = D.priority, 
                    M = v, v = d.$$element = B(X.createComment(" " + y + ": " + d[y] + " ")), b = v[0], 
                    U(f, ua.call(M, 0), b), Ka = W(M, e, H, g && g.name, {
                        nonTlbTranscludeDirective: z
                    })) : (M = B(Ub(b)).contents(), v.empty(), Ka = W(M, e))), D.template) if (m = !0, 
                    Q("template", L, D, v), L = D, M = x(D.template) ? D.template(v, d) : D.template, 
                    M = ha(M), D.replace) {
                        if (g = D, M = Sb.test(M) ? Xc(Xb(D.templateNamespace, T(M))) : [], b = M[0], 1 != M.length || b.nodeType !== pa) throw ga("tplrt", y, "");
                        U(f, v, b), F = {
                            $attr: {}
                        }, M = ca(b, [], F);
                    ...
                    if (D.templateUrl) m = !0, Q("template", L, D, v), L = D, D.replace && (g = D), 
                ...
                return K.scope = S && !0 === S.scope, K.transcludeOnThisElement = N, K.templateOnThisElement = m, 
                K.transclude = Ka, r.hasElementTranscludeDirective = ia, K;
            }
            function A(a) {
                for (var b = 0, c = a.length; c > b; b++) a[b] = Nb(a[b], {
                    $$isolateScope: !0
                });
            }
            function na(b, d, f, g, h, k, l) {
                ...
                if (h = null, e.hasOwnProperty(d)) {
                    var n;
                    d = a.get(d + "Directive");
                    for (var q = 0, t = d.length; t > q; q++) try {
            ...
            function Yc(a, b) {
                ...
                m(a, function(d, e) {
                    ...
                    "class" == f ? (L(e, b), a["class"] = (a["class"] ? a["class"] + " " : "") + b) : "style" == f ? (e.attr("style", e.attr("style") + ";" + b), 
                    a.style = (a.style ? a.style + ";" : "") + b) : "$" == f.charAt(0) || a.hasOwnProperty(f) || (a[f] = b, 
                    d[f] = c[f]);
                });
            }
            function Mf(a, b, c, e, f, g, h, k) {
                var r, n, l = [], q = b[0], t = a.shift(), H = Nb(t, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: t
                }), O = x(t.templateUrl) ? t.templateUrl(b, c) : t.templateUrl, E = t.templateNamespace;
                return b.empty(), d(O).then(function(d) {
                    var K, u;
                    if (d = ha(d), t.replace) {
                        if (d = Sb.test(d) ? Xc(Xb(E, T(d))) : [], K = d[0], 1 != d.length || K.nodeType !== pa) throw ga("tplrt", t.name, O);
                        d = {
                            $attr: {}
                        }, U(e, b, K);
                        var z = ca(K, [], d);
                    ...
                    for (a.unshift(H), r = D(a, K, c, f, b, t, g, h, k), m(e, function(a, c) {
                        a == K && (e[c] = b[0]);
                    ...
                    a = e, b.$$destroyed || (l ? l.push(b, c, d, a) : (r.transcludeOnThisElement && (a = ba(b, r.transclude, e)), 
                    r(n, b, c, d, a, r)));
                };
            }
            function M(a, b) {
            ...
            function Ka(a, c) {
                ...
                d && a.push({
                    ...
                    compile: function(a) {
                        a = a.parent();
                        var b = !!a.length;
                        return b && W.$$addBindingClass(a), function(a, c) {
                            var e = c.parent();
                            b || W.$$addBindingClass(e), W.$$addBindingInfo(e, d.expressions), a.$watch(d, function(a) {
                                c[0].nodeValue = a;
                            });
                        };
                    }
            ...
            function R(a, b) {
                ...
                var c = wa(a);
                return "xlinkHref" == b || "form" == c && "action" == b || "img" != c && ("src" == b || "ngSrc" == b) ? ia.RESOURCE_URL : void 0;
            }
                        ...
                        compile: function() {
                            return {
                                pre: function(a, c, g) {
                                    ...
                                    var r = g[e];
                                    r !== d && (l = r && b(r, !0, h, f), d = r), l && (g[e] = l(a), (c[e] || (c[e] = [])).$$inter = !0, 
            ...
            function Y(a, c, d, e, f, g) {
                ...
                return m(e, function(e, g) {
                    var r, n, q, K, k = e.attrName, l = e.optional;
                    switch (e.mode) {
                      case "@":
                        l || ta.call(c, k) || (d[g] = c[k] = void 0), c.$observe(k, function(a) {
                            G(a) && (d[g] = a);
                        }), c.$$observers[k].$$scope = a, G(c[k]) && (d[g] = b(c[k])(a));
                        break;
                      ...
                      case "=":
                        ...
                        if (l && !c[k]) break;
                        n = u(c[k]), K = n.literal ? ka : function(a, b) {
                            return a === b || a !== a && b !== b;
                        }, q = n.assign || function() {
                            throw r = d[g] = n(a), ga("nonassign", c[k], f.name);
                        }, r = d[g] = n(a), l = function(b) {
                            return K(b, d[g]) || (K(b, r) ? q(a, b = d[g]) : d[g] = b), r = b;
                        }, l.$stateful = !0, l = e.collection ? a.$watchCollection(c[k], l) : a.$watch(u(c[k], l), null, n.literal), 
                        h = h || [], h.push(l);
                        break;

                      case "&":
                        if (n = c.hasOwnProperty(k) ? u(c[k]) : y, n === y && l) break;
                        d[g] = function(b) {
                            return n(a, b);
                        };
                    }
            ...
            Z.prototype = {
                ...
                $updateClass: function(a, b) {
                    var c = Zc(a, b);
                    c && c.length && O.addClass(this.$$element, c), (c = Zc(b, a)) && c.length && O.removeClass(this.$$element, c);
                },
                $set: function(a, b, d, e) {
                    ...
                    f = wa(this.$$element), "a" === f && "href" === a || "img" === f && "src" === a) this[a] = b = H(b, "src" === a); else if ("img" === f && "srcset" === a) {
                        for (var f = "", g = T(b), k = /(\s+\d+x\s*,|\s+\d+w\s*,|\s+,|,\s+)/, k = /\s/.test(g) ? k : /(,)/, g = g.split(k), k = Math.floor(g.length / 2), l = 0; k > l; l++) var r = 2 * l, f = f + H(T(g[r]), !0), f = f + (" " + T(g[r + 1]));
                        g = T(g[2 * l]).split(/\s/), f += H(T(g[0]), !0), 2 === g.length && (f += " " + T(g[1])), 
                        this[a] = b = f;
                    }
            ...
            return W.$$addBindingInfo = n ? function(a, b) {
        ...
        this.register = function(a, d) {
            ...
            return function(f, h, g, l) {
                ...
                if (g = !0 === g, l && G(l) && (p = l), G(f)) {
                    if (l = f.match(Vc), !l) throw Of("ctrlfmt", f);
                    n = l[1], p = p || l[3], f = b.hasOwnProperty(n) ? b[n] : Cc(h.$scope, n, !0) || (a ? Cc(d, n, !0) : w), 
                    Sa(f, n, !0);
                }
                return g ? (g = (J(f) ? f[f.length - 1] : f).prototype, k = Object.create(g || null), 
                p && e(h, p, k, n || f.name), P(function() {
    ...
    function cd(b) {
        var a;
        return function(c) {
            return a || (a = bd(b)), c ? (c = a[F(c)], void 0 === c && (c = null), c) : a;
        };
    }
    function dd(b, a, c, d) {
        return x(d) ? d(b, a, c) : (m(d, function(d) {
            b = d(b, a, c);
        }), b);
    }
    function cf() {
        ...
        this.$get = [ "$httpBackend", "$$cookieReader", "$cacheFactory", "$rootScope", "$q", "$injector", function(e, f, h, g, l, k) {
            function n(a) {
                function d(a) {
                    var b = P({}, a);
                    return b.data = a.data ? dd(a.data, a.headers, a.status, f.transformResponse) : a.data, 
                    a = a.status, a >= 200 && 300 > a ? b : l.reject(b);
                }
                function e(a, b) {
                    var c, d = {};
                    return m(a, function(a, e) {
                ...
                f.headers = function(a) {
                    var f, g, h, c = b.headers, d = P({}, a.headers), c = P({}, c.common, c[F(a.method)]);
                    a: for (f in c) {
                        g = F(f);
                    ...
                    return e(d, ja(a));
                }(a), f.method = sb(f.method), f.paramSerializer = G(f.paramSerializer) ? k.get(f.paramSerializer) : f.paramSerializer;
                var g = [ function(a) {
                    var c = a.headers, e = dd(a.data, cd(c), w, a.transformRequest);
                    return v(e) && m(c, function(a, b) {
                ...
                return c ? (h.success = function(a) {
                    return Sa(a, "fn"), h.then(function(b) {
                        a(b.data, b.status, b.headers, f);
                    }), h;
                }, h.error = function(a) {
                    return Sa(a, "fn"), h.then(null, function(b) {
                        a(b.data, b.status, b.headers, f);
                    }), h;
                }) : (h.success = ed("success"), h.error = ed("error")), h;
            }
            function p(c, d) {
                function h(b, c, d, e) {
                    function f() {
                    ...
                    L && (b >= 200 && 300 > b ? L.put(ba, [ b, c, bd(d), e ]) : L.remove(ba)), a ? g.$applyAsync(f) : (f(), 
                    g.$$phase || g.$apply());
                }
                function k(a, b, d, e) {
                    b = b >= -1 ? b : 0, (b >= 200 && 300 > b ? O.resolve : O.reject)({
                        data: a,
                        status: b,
                        headers: cd(d),
                        config: c,
                ...
                var L, m, O = l.defer(), H = O.promise, S = c.headers, ba = r(c.url, c.paramSerializer(c.params));
                return n.pendingRequests.push(c), H.then(E, E), !c.cache && !b.cache || !1 === c.cache || "GET" !== c.method && "JSONP" !== c.method || (L = C(c.cache) ? c.cache : C(b.cache) ? b.cache : t), 
                L && (m = L.get(ba), A(m) ? m && x(m.then) ? m.then(p, p) : J(m) ? k(m[1], m[0], ja(m[2]), m[3]) : k(m, 200, {}, "OK") : L.put(ba, H)), 
                v(m) && ((m = fd(c.url) ? f()[c.xsrfCookieName || b.xsrfCookieName] : w) && (S[c.xsrfHeaderName || b.xsrfHeaderName] = m), 
                e(c.method, ba, d, h, S, c.timeout, c.withCredentials, c.responseType)), H;
            }
            function r(a, b) {
    ...
    function Sf(b, a, c, d, e) {
        function f(a, b, c) {
            ...
            return f.type = "text/javascript", f.src = a, f.async = !0, n = function(a) {
                ...
                a && ("load" !== a.type || d[b].called || (a = {
                    type: "error"
                }), t = a.type, h = "error" === a.type ? 404 : 200), c && c(h, t);
        ...
        return function(e, g, l, k, n, p, r, t) {
            ...
            if (b.$$incOutstandingRequestCount(), g = g || b.url(), "jsonp" == F(e)) {
                ...
                var z = a(e, g);
                if (z.open(e, g, !0), m(n, function(a, b) {
                    A(a) && z.setRequestHeader(b, a);
                }), z.onload = function() {
                    var a = z.statusText || "", b = "response" in z ? z.response : z.responseText, c = 1223 === z.status ? 204 : z.status;
                    0 === c && (c = b ? 200 : "file" == Aa(g).protocol ? 404 : 0), K(k, c, b, z.getAllResponseHeaders(), a);
                }, e = function() {
                    K(k, -1, null, null, "");
                }, z.onerror = e, z.onabort = e, r && (z.withCredentials = !0), t) try {
                    z.responseType = t;
                } catch (N) {
                    if ("json" !== t) throw N;
                }
            ...
            if (p > 0) var s = c(E, p); else p && x(p.then) && p.then(E);
        };
    }
    function af() {
        var b = "{{", a = "}}";
        this.startSymbol = function(a) {
            ...
            function g(f, g, n, p) {
                ...
                p = !!p;
                for (var q, m, N = 0, s = [], O = [], H = f.length, L = [], W = []; H > N; ) {
                    if (-1 == (q = f.indexOf(b, N)) || -1 == (m = f.indexOf(a, q + l))) {
                        N !== H && L.push(h(f.substring(N)));
                        break;
                    }
                    N !== q && L.push(h(f.substring(N, q))), N = f.substring(q + l, m), s.push(N), O.push(c(N, u)), 
    ...
    function bf() {
        this.$get = [ "$rootScope", "$window", "$q", "$$q", function(b, a, c, d) {
            function e(e, g, l, k) {
                ...
                return l = A(l) ? l : 0, q.then(null, null, n ? function() {
                    e.apply(null, p);
                } : e), q.$$intervalId = r(function() {
                    u.notify(E++), l > 0 && E >= l && (u.resolve(E), t(q.$$intervalId), delete f[q.$$intervalId]), 
                    K || b.$apply();
                }, g), f[q.$$intervalId] = u, q;
            }
            var f = {};
    ...
    function hd(b, a) {
        ...
        a.$$search = yc(d.search), a.$$hash = decodeURIComponent(d.hash), a.$$path && "/" != a.$$path.charAt(0) && (a.$$path = "/" + a.$$path);
    }
    function sa(b, a) {
    ...
    function bc(b, a, c) {
        this.$$html5 = !0, c = c || "", gd(b, this), this.$$parse = function(b) {
            ...
            var f, h;
            return A(f = sa(b, d)) ? (h = f, h = A(f = sa(c, f)) ? a + (sa("/", f) || f) : b + h) : A(f = sa(a, d)) ? h = a + f : a == d + "/" && (h = a), 
            h && this.$$parse(h), !!h;
        };
    }
    function cc(b, a, c) {
        gd(b, this), this.$$parse = function(d) {
            var f, e = sa(b, d) || sa(a, d);
            v(e) || "#" !== e.charAt(0) ? this.$$html5 ? f = e : (f = "", v(e) && (b = d, this.replace())) : (f = sa(c, e), 
            v(f) && (f = e)), hd(f, this), d = this.$$path;
            var e = b, h = /^\/[A-Z]:(\/.*)/;
            0 === f.indexOf(e) && (f = f.replace(e, "")), h.exec(f) || (d = (f = h.exec(d)) ? f[1] : d), 
            this.$$path = d, this.$$compose();
        }, this.$$compose = function() {
            var a = Pb(this.$$search), e = this.$$hash ? "#" + ob(this.$$hash) : "";
            this.$$url = ac(this.$$path) + (a ? "?" + a : "") + e, this.$$absUrl = b + (this.$$url ? c + this.$$url : "");
    ...
    function id(b, a, c) {
        this.$$html5 = !0, cc.apply(this, arguments), this.$$parseLinkUrl = function(d, e) {
            if (e && "#" === e[0]) return this.hash(e.slice(1)), !0;
            var f, h;
            return b == Ja(d) ? f = d : (h = sa(a, d)) ? f = b + c + h : a === d + "/" && (f = a), 
            f && this.$$parse(f), !!f;
        }, this.$$compose = function() {
            var a = Pb(this.$$search), e = this.$$hash ? "#" + ob(this.$$hash) : "";
    ...
    function hf() {
        ...
        this.hashPrefix = function(a) {
            ...
            return bb(b) ? (a.enabled = b, this) : C(b) ? (bb(b.enabled) && (a.enabled = b.enabled), 
            ...
            k = new n(r, t, "#" + b), k.$$parseLinkUrl(p, p), k.$$state = d.state();
            ...
            f.on("click", function(b) {
                if (a.rewriteLinks && !b.ctrlKey && !b.metaKey && !b.shiftKey && 2 != b.which && 2 != b.button) {
                    ...
                    E.test(g) || !g || e.attr("target") || b.isDefaultPrevented() || !k.$$parseLinkUrl(g, l) || (b.preventDefault(), 
    ...
    function Xa(b, a) {
        if ("__defineGetter__" === b || "__defineSetter__" === b || "__lookupGetter__" === b || "__lookupSetter__" === b || "__proto__" === b) throw Z("isecfld", a);
        return b;
    }
    function kd(b, a) {
        if (b += "", !G(b)) throw Z("iseccst", a);
        return b;
    }
    function Ba(b, a) {
        if (b) {
    ...
    function U(b, a) {
        ...
        switch (b.type) {
          ...
          case s.BinaryExpression:
            U(b.left, a), U(b.right, a), b.constant = b.left.constant && b.right.constant, b.toWatch = b.left.toWatch.concat(b.right.toWatch);
            break;

          case s.LogicalExpression:
            U(b.left, a), U(b.right, a), b.constant = b.left.constant && b.right.constant, b.toWatch = b.constant ? [] : [ b ];
            break;

          case s.ConditionalExpression:
            U(b.test, a), U(b.alternate, a), U(b.consequent, a), b.constant = b.test.constant && b.alternate.constant && b.consequent.constant, 
          ...
          case s.MemberExpression:
            U(b.object, a), b.computed && U(b.property, a), b.constant = b.object.constant && (!b.computed || b.property.constant), 
            b.toWatch = [ b ];
            break;
    ...
    function qd(b) {
        return 1 === b.body.length && pd(b.body[0].expression) ? {
    ...
    function kf() {
        ...
        this.$get = [ "$filter", function(c) {
            ...
            function e(a, b, c, e, f) {
                ...
                for (var l = [], n = [], p = 0, m = g.length; m > p; p++) l[p] = d, n[p] = null;
                return a.$watch(function(a) {
            ...
            return function(d, k, E) {
                ...
                switch (typeof d) {
                  case "string":
                    q = d = d.trim();
                    var s = E ? a : b;
                    return m = s[q], m || (":" === d.charAt(0) && ":" === d.charAt(1) && (u = !0, d = d.substring(2)), 
                    E = E ? p : n, m = new ec(E), m = new fc(m, c, E).parse(d), m.constant ? m.$$watchDelegate = g : u ? m.$$watchDelegate = m.literal ? h : f : m.inputs && (m.$$watchDelegate = e), 
                    s[q] = m), l(m, k);
    ...
    function ud(b, a) {
        ...
        P(d.prototype, {
            ...
            $$resolve: function(b) {
                ...
                try {
                    (C(b) || x(b)) && (d = b && b.then), x(d) ? (this.promise.$$state.status = -1, d.call(b, e[0], e[1], this.notify)) : (this.promise.$$state.value = b, 
        ...
        this.digestTtl = function(b) {
            ...
            n.prototype = {
                ...
                $watch: function(a, b, c, e) {
                    ...
                    return d = null, x(b) || (l.fn = y), k || (k = h.$$watchers = []), k.unshift(l), 
                    r(this, 1), function() {
                ...
                $watchCollection: function(a, b) {
                    function c(a) {
                        ...
                        var b, d, g, h;
                        if (!v(e)) {
                            if (C(e)) if (Da(e)) for (f !== p && (f = p, t = f.length = 0, l++), a = e.length, 
                            t !== a && (l++, f.length = t = a), b = 0; a > b; b++) h = f[b], g = e[b], d = h !== h && g !== g, 
                            d || h === g || (l++, f[b] = g); else {
                                f !== r && (f = r = {}, t = 0, l++), a = 0;
                    ...
                    c.$stateful = !0;
                    var e, f, h, d = this, k = 1 < b.length, l = 0, n = g(a, c), p = [], r = {}, q = !0, t = 0;
                    return this.$watch(n, function() {
                        if (q ? (q = !1, b(e, e, d)) : b(e, h, d), k) if (C(e)) if (Da(e)) {
                            h = Array(e.length);
                ...
                $digest: function() {
                    var b, f, g, k, n, r, m, D, v, t = a, u = [];
                    p("$digest"), l.$$checkUrlChange(), this === q && null !== e && (l.defer.cancel(e), 
                    s()), d = null;
                    do {
                        ...
                        a: do {
                            if (k = m.$$watchers) for (n = k.length; n--; ) try {
                                if (b = k[n]) if ((f = b.get(m)) === (g = b.last) || (b.eq ? ka(f, g) : "number" == typeof f && "number" == typeof g && isNaN(f) && isNaN(g))) {
                                    if (b === d) {
                                        r = !1;
                                        break a;
                                    }
                                } else r = !0, d = b, b.last = b.eq ? ha(f, null) : f, b.fn(f, g === E ? f : g, m), 
                ...
                $destroy: function() {
                    if (!this.$$destroyed) {
                        var a = this.$parent;
                        this.$broadcast("$destroy"), this.$$destroyed = !0, this === q && l.$$applicationDestroyed(), 
                ...
                $emit: function(a, b) {
                    ...
                    do {
                        for (d = e.$$listeners[a] || c, g.currentScope = e, l = 0, n = d.length; n > l; l++) if (d[l]) try {
                            d[l].apply(null, k);
                        } catch (p) {
                            h(p);
                ...
                $broadcast: function(a, b) {
                    ...
                    for (var g, k, f = db([ e ], arguments, 1); c = d; ) {
                        for (e.currentScope = c, d = c.$$listeners[a] || [], g = 0, k = d.length; k > g; g++) if (d[g]) try {
                            d[g].apply(null, f);
                        } catch (l) {
                            h(l);
    ...
    function ge() {
        ...
        this.aHrefSanitizationWhitelist = function(a) {
            ...
            return function(c, d) {
                var f, e = d ? a : b;
                return f = Aa(c).href, "" === f || f.match(e) ? c : "unsafe:" + f;
            };
        };
    }
    function Zf(b) {
        ...
        if (G(b)) {
            ...
            return b = vd(b).replace("\\*\\*", ".*").replace("\\*", "[^:/.?&;]*"), new RegExp("^" + b + "$");
        }
    ...
    function pf() {
        ...
        this.resourceUrlWhitelist = function(a) {
            ...
            var h = e(), g = {};
            return g[oa.HTML] = e(h), g[oa.CSS] = e(h), g[oa.URL] = e(h), g[oa.JS] = e(h), g[oa.RESOURCE_URL] = e(g[oa.URL]), 
            {
                ...
                getTrusted: function(c, e) {
                    ...
                    if (c === oa.RESOURCE_URL) {
                        var p, r, h = Aa(e.toString()), t = !1;
                        for (p = 0, r = b.length; r > p; p++) if (d(b[p], h)) {
                            t = !0;
                            break;
                        }
                        if (t) for (p = 0, r = a.length; r > p; p++) if (d(a[p], h)) {
                            t = !1;
                            break;
                        }
                        if (t) return e;
    ...
    function qf() {
        this.$get = [ "$window", "$document", function(b, a) {
            var h, c = {}, d = Y((/android (\d+)/.exec(F((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, g = /^(Moz|webkit|ms)(?=[A-Z])/, l = f.body && f.body.style, k = !1, n = !1;
            if (l) {
                for (var p in l) if (k = g.exec(p)) {
                    h = k[0], h = h.substr(0, 1).toUpperCase() + h.substr(1);
                    break;
                }
                h || (h = "WebkitOpacity" in l && "webkit"), k = !!("transition" in l || h + "Transition" in l), 
                n = !!("animation" in l || h + "Animation" in l), !d || k && n || (k = G(l.webkitTransition), 
    ...
    function sf() {
        this.$get = [ "$templateCache", "$http", "$q", "$sce", function(b, a, c, d) {
            function e(f, h) {
                ...
                return J(g) ? g = g.filter(function(a) {
                    return a !== Zb;
                }) : g === Zb && (g = null), a.get(f, {
                    cache: b,
                    transformResponse: g
    ...
    function uf() {
        this.$get = [ "$rootScope", "$browser", "$q", "$$q", "$exceptionHandler", function(b, a, c, d, e) {
            function f(f, l, k) {
                x(f) || (k = l, l = f, f = y);
                var m, n = ua.call(arguments, 3), p = A(k) && !k, r = (p ? d : c).defer(), t = r.promise;
                return m = a.defer(function() {
                    try {
    ...
    function Aa(b) {
        return Wa && ($.setAttribute("href", b), b = $.href), $.setAttribute("href", b), 
        {
            href: $.href,
    ...
    function fd(b) {
        return b = G(b) ? Aa(b) : b, b.protocol === xd.protocol && b.host === xd.host;
    }
    function vf() {
        this.$get = qa(Q);
    }
    function yd(b) {
        ...
        return function() {
            var b, h, g, l, k;
            if (b = c.cookie || "", b !== e) for (e = b, b = e.split("; "), d = {}, g = 0; g < b.length; g++) h = b[g], 
            l = h.indexOf("="), l > 0 && (k = a(h.substring(0, l)), v(d[k]) && (d[k] = a(h.substring(l + 1))));
            return d;
        };
    }
    function zf() {
    ...
    function Kc(b) {
        ...
        } ], a("currency", zd), a("date", Ad), a("filter", $f), a("json", ag), a("limitTo", bg), 
        a("lowercase", cg), a("number", Bd), a("orderBy", Cd), a("uppercase", dg);
    }
    function $f() {
    ...
    function eg(b, a, c) {
        var d = C(b) && "$" in b;
        return !0 === a ? a = ka : x(a) || (a = function(a, b) {
            return v(a) ? !1 : null === a || null === b ? a === b : C(b) || C(a) && !qc(a) ? !1 : (a = F("" + a), 
            b = F("" + b), -1 !== a.indexOf(b));
        }), function(e) {
    ...
    function zd(b) {
        ...
        return function(b, d, e) {
            return v(d) && (d = a.CURRENCY_SYM), v(e) && (e = a.PATTERNS[1].maxFrac), null == b ? b : Dd(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, e).replace(/\u00A4/g, d);
        };
    }
    function Bd(b) {
        var a = b.NUMBER_FORMATS;
    ...
    function Dd(b, a, c, d, e) {
        ...
        var g = b + "", l = "", k = !1, n = [];
        if (h && (l = "∞"), !h && -1 !== g.indexOf("e")) {
            var p = g.match(/([\d\.]+)e(-?)(\d+)/);
            p && "-" == p[2] && p[3] > e + 1 ? b = 0 : (l = g, k = !0);
        }
        if (h || k) e > 0 && 1 > b && (l = b.toFixed(e), b = parseFloat(l), l = l.replace(hc, d)); else {
            ...
            if (g.length >= r + t) for (p = g.length - r, k = 0; p > k; k++) 0 === (p - k) % t && 0 !== k && (l += c), 
            l += g.charAt(k);
    ...
    function Ad(b) {
        function a(a) {
            ...
            if (b = a.match(c)) {
                ...
                b[9] && (f = Y(b[9] + b[10]), h = Y(b[9] + b[11])), g.call(a, Y(b[1]), Y(b[2]) - 1, Y(b[3])), 
                f = Y(b[4] || 0) - f, h = Y(b[5] || 0) - h, g = Y(b[6] || 0), b = Math.round(1e3 * parseFloat("0." + (b[7] || 0))), 
                l.call(a, f, h, g, b);
            }
            return a;
        }
        ...
        return function(c, e, f) {
            var l, k, h = "", g = [];
            if (e = e || "mediumDate", e = b.DATETIME_FORMATS[e] || e, G(c) && (c = fg.test(c) ? Y(c) : a(c)), 
            V(c) && (c = new Date(c)), !ea(c) || !isFinite(c.getTime())) return c;
            for (;e; ) (k = gg.exec(e)) ? (g = db(g, k, 1), e = g.pop()) : (g.push(e), e = null);
            var n = c.getTimezoneOffset();
            return f && (n = wc(f, c.getTimezoneOffset()), c = Ob(c, f, !0)), m(g, function(a) {
    ...
    function bg() {
        return function(b, a, c) {
            return a = 1 / 0 === Math.abs(Number(a)) ? Number(a) : Y(a), isNaN(a) ? b : (V(b) && (b = b.toString()), 
            J(b) || G(b) ? (c = !c || isNaN(c) ? 0 : Y(c), c = 0 > c && c >= -b.length ? b.length + c : c, 
    ...
    function Cd(b) {
        function a(a, c) {
            return c = c ? -1 : 1, a.map(function(a) {
                var d = 1, g = $a;
                if (x(a)) g = a; else if (G(a) && (("+" == a.charAt(0) || "-" == a.charAt(0)) && (d = "-" == a.charAt(0) ? -1 : 1, 
                a = a.substring(1)), "" !== a && (g = b(a), g.constant))) var l = g(), g = function(a) {
                    return a[l];
                };
                return {
                    get: g,
        ...
        return function(b, e, f) {
            ...
            return h.push({
                ...
                for (var c = 0, d = 0, e = h.length; e > d; ++d) {
                    ...
                    if (c.type === f.type ? c.value !== f.value && (t = c.value < f.value ? -1 : 1) : t = c.type < f.type ? -1 : 1, 
                    c = t * h[d].descending) break;
                }
                return c;
            }), b = b.map(function(a) {
                return a.value;
    ...
    function Na(b) {
        return x(b) && (b = {
            link: b
        }), b.restrict = b.restrict || "AC", qa(b);
    }
    function Gd(b, a, c, d, e) {
        var f = this, h = [];
        f.$error = {}, f.$$success = {}, f.$pending = w, f.$name = e(a.name || a.ngForm || "")(c), 
        ...
        f.$$parentForm = Ib, f.$rollbackViewValue = function() {
            ...
            d.setClass(b, Ya, Jb + " ng-submitted"), f.$dirty = !1, f.$pristine = !0, f.$submitted = !1, 
            m(h, function(a) {
                a.$setPristine();
            });
    ...
    function jb(b, a, c, d, e, f) {
        ...
        var l = function(b) {
            if (k && (f.defer.cancel(k), k = null), !g) {
                var e = a.val();
                b = b && b.type, "password" === h || c.ngTrim && "false" === c.ngTrim || (e = T(e)), 
    ...
    function kb(b, a, c, d) {
        return function(e, f, h, g, l, k, n) {
            ...
            Id(e, f, h, g), jb(e, f, h, g, l, k);
            var m, t = g && g.$options && g.$options.timezone;
            if (g.$$parserName = b, g.$parsers.push(function(b) {
    ...
    function Jd(b, a, c, d, e) {
        if (A(d)) {
            if (b = b(d), !b.constant) throw lb("constexpr", c, d);
            return b(a);
        }
        return e;
    }
        ...
        return b = "ngClass" + b, [ "$animate", function(c) {
            ...
            return {
                ...
                link: function(f, h, g) {
                    ...
                    var n;
                    f.$watch(g[b], k, !0), g.$observe("class", function(a) {
                        k(f.$eval(g[b]));
    ...
    function Hd(b) {
        ...
        f[Kd] = !(f[mb] = e.hasClass(mb)), d.$setValidity = function(b, e, f) {
            v(e) ? (d.$pending || (d.$pending = {}), h(d.$pending, b, f)) : (d.$pending && g(d.$pending, b, f), 
            Ld(d.$pending) && (d.$pending = w)), bb(e) ? e ? (g(d.$error, b, f), h(d.$$success, b, f)) : (h(d.$error, b, f), 
            g(d.$$success, b, f)) : (g(d.$error, b, f), g(d.$$success, b, f)), d.$pending ? (a(Md, !0), 
            d.$valid = d.$invalid = w, c("", null)) : (a(Md, !1), d.$valid = Ld(d.$error), d.$invalid = !d.$valid, 
            c("", d.$valid)), e = d.$pending && d.$pending[b] ? w : d.$error[b] ? !1 : d.$$success[b] ? !0 : null, 
            c(b, e), d.$$parentForm.$setValidity(b, e, d);
        };
    }
    function Ld(b) {
    ...
    var Wa, B, ra, Rb, jg = /^\/(.+)\/([a-z]*)$/, F = function(b) {
        return G(b) ? b.toLowerCase() : b;
    }, ta = Object.prototype.hasOwnProperty, sb = function(b) {
        return G(b) ? b.toUpperCase() : b;
    }, ua = [].slice, Nf = [].splice, kg = [].push, va = Object.prototype.toString, rc = Object.getPrototypeOf, Ea = I("ng"), da = Q.angular || (Q.angular = {}), nb = 0;
    Wa = X.documentMode, y.$inject = [], $a.$inject = [];
    var Qb, J = Array.isArray, tc = /^\[object (Uint8(Clamped)?)|(Uint16)|(Uint32)|(Int8)|(Int16)|(Int32)|(Float(32)|(64))Array\]$/, T = function(b) {
        return G(b) ? b.trim() : b;
    }, vd = function(b) {
        ...
        var b, a, d, e, c = Qa.length;
        for (a = 0; c > a; ++a) if (d = Qa[a], b = X.querySelector("[" + d.replace(":", "\\:") + "jq]")) {
            e = b.getAttribute(d + "jq");
            break;
        }
        return pb.name_ = e;
    }, Qa = [ "ng-", "data-ng-", "ng:", "x-ng-" ], be = /[A-Z]/g, Bc = !1, pa = 1, Pa = 3, fe = {
        full: "1.4.7",
        major: 1,
        minor: 4,
        dot: 7,
    ...
    }, Tb = I("jqLite"), Ef = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Sb = /<|&#?\w+;/, Cf = /<([\w:-]+)/, Df = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, ma = {
    ...
    m({
        ...
        hasClass: xb,
        css: function(b, a, c) {
            return a = gb(a), A(c) ? void (b.style[a] = c) : b.style[a];
        },
        attr: function(b, a, c) {
            var d = b.nodeType;
            if (d !== Pa && 2 !== d && 8 !== d) if (d = F(a), Bb[d]) {
                if (!A(c)) return b[a] || (b.attributes.getNamedItem(a) || y).specified ? d : w;
                c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d));
            } else if (A(c)) b.setAttribute(a, c); else if (b.getAttribute) return b = b.getAttribute(a, 2), 
            null === b ? w : b;
        },
        prop: function(b, a, c) {
            return A(c) ? void (b[a] = c) : b[a];
        },
        text: function() {
            function b(a, b) {
                if (v(b)) {
        ...
        html: function(b, a) {
            return v(a) ? b.innerHTML : (ub(b, !0), void (b.innerHTML = a));
        },
        empty: Qc
    }, function(b, a) {
        R.prototype[a] = function(a, d) {
            ...
            if (b !== Qc && v(2 == b.length && b !== xb && b !== Pc ? a : d)) {
                if (C(a)) {
                    for (e = 0; h > e; e++) if (b === Vb) b(this[e], a); else for (f in a) b(this[e], f, a[f]);
                    return this;
                }
                for (e = b.$dv, h = v(e) ? Math.min(h, 1) : h, f = 0; h > f; f++) {
                    var g = b(this[f], a, d);
                    e = e ? e + g : g;
                }
                return e;
            }
            for (e = 0; h > e; e++) b(this[e], a, d);
            return this;
        };
    }), m({
        removeData: vb,
        ...
        R.prototype[c] = function(c, e, f) {
            for (var h, g = 0, l = this.length; l > g; g++) v(h) ? (h = a(this[g], c, e, f), 
            A(h) && (h = B(h))) : Nc(h, a(this[g], c, e, f));
            return A(h) ? h : this;
    ...
    } ], Uc = /^[^\(]*\(\s*([^\)]*)\)/m, mg = /,/, ng = /^\s*(_?)(\S+?)\1\s*$/, Tc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ha = I("$injector");
        ...
        if ("function" == typeof a) {
            if (!(e = a.$inject)) {
                if (e = [], a.length) {
                    ...
                    c = a.toString().replace(Tc, ""), c = c.match(Uc), m(c[1].split(mg), function(a) {
    ...
    var Nd = I("$animate"), Ue = function() {
        this.$get = [ "$q", "$$rAF", function(a, c) {
            function d() {}
            return d.all = y, d.chain = y, d.prototype = {
                end: y,
                cancel: y,
                resume: y,
                pause: y,
        ...
        this.$get = [ "$$AnimateRunner", "$rootScope", function(d, e) {
            function f(a, c, d) {
                var e = !1;
                return c && (c = G(c) ? c.split(" ") : J(c) ? c : [], m(c, function(c) {
                    c && (e = !0, a[c] = d);
                })), e;
            }
            function h() {
            ...
            return {
                ...
                push: function(g, l, k, n) {
                    return n && n(), k = k || {}, k.from && g.css(k.from), k.to && g.css(k.to), (k.addClass || k.removeClass) && (l = k.addClass, 
                    n = k.removeClass, k = a.get(g) || {}, l = f(k, l, !0), n = f(k, n, !1), (l || n) && (a.put(g, k), 
                    c.push(g), 1 === c.length && e.$$postDigest(h))), new d();
                }
            };
        } ];
        ...
        this.$$registeredAnimations = Object.create(null), this.register = function(d, e) {
            ...
            return {
                ...
                enter: function(f, h, g, l) {
                    return h = h && B(h), g = g && B(g), h = h || g.parent(), c(f, h, g), a.push(f, "enter", Ia(l));
                },
                move: function(f, h, g, l) {
                    return h = h && B(h), g = g && B(g), h = h || g.parent(), c(f, h, g), a.push(f, "move", Ia(l));
                },
                leave: function(c, e) {
                ...
                addClass: function(c, e, g) {
                    return g = Ia(g), g.addClass = ib(g.addclass, e), a.push(c, "addClass", g);
                },
                removeClass: function(c, e, g) {
                    return g = Ia(g), g.removeClass = ib(g.removeClass, e), a.push(c, "removeClass", g);
                },
                setClass: function(c, e, g, l) {
                    return l = Ia(l), l.addClass = ib(l.addClass, e), l.removeClass = ib(l.removeClass, g), 
                    a.push(c, "setClass", l);
                },
                animate: function(c, e, g, l, k) {
                    return k = Ia(k), k.from = k.from ? P(k.from, e) : e, k.to = k.to ? P(k.to, g) : g, 
                    k.tempClasses = ib(k.tempClasses, l || "ng-inline-animate"), a.push(c, "animate", k);
                }
            };
        } ];
    } ], Se = function() {
        this.$get = [ "$$rAF", "$q", function(a, c) {
            ...
            return d.prototype = {
                ...
                function h() {
                    return a(function() {
                        f.addClass && (c.addClass(f.addClass), f.addClass = null), f.removeClass && (c.removeClass(f.removeClass), 
                        f.removeClass = null), f.to && (c.css(f.to), f.to = null), g || l.done(), g = !0;
                    }), l;
                }
    ...
    var Wc = /^((?:x|data)[\:\-_])/i, Of = I("$controller"), Vc = /^(\S+)(\s+as\s+(\w+))?$/, $e = function() {
        this.$get = [ "$document", function(a) {
            return function(c) {
                return c ? !c.nodeType && c instanceof B && (c = c[0]) : c = a[0].body, c.offsetWidth + 1;
            };
        } ];
    }, ad = "application/json", $b = {
    ...
    var pg = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, Tf = {
        ...
        search: function(a, c) {
            switch (arguments.length) {
              ...
              case 1:
                if (G(a) || V(a)) a = a.toString(), this.$$search = yc(a); else {
    ...
    ec.prototype = {
        ...
        throwError: function(a, c, d) {
            throw d = d || this.index, c = A(c) ? "s " + c + "-" + this.index + " [" + this.text.substring(c, d) + "]" : " " + d, 
    ...
    s.prototype = {
        ...
        compile: function(a, c) {
            ...
            var h, f = "";
            return this.stage = "assign", (h = qd(e)) && (this.state.computing = "assign", f = this.nextId(), 
            this.recurse(h, f), this.return_(f), f = "fn.assign=" + this.generateFunction("assign", "s,v,l")), 
            h = od(e.body), d.stage = "inputs", m(h, function(a, c) {
                var e = "fn" + c;
                d.state[e] = {
                    vars: [],
                    body: [],
            ...
            this.state = this.stage = w, f.literal = rd(e), f.constant = e.constant, f;
        },
        USE: "use",
        STRICT: "strict",
        watchFns: function() {
        ...
        recurse: function(a, c, d, e, f, h) {
            var g, l, n, p, k = this;
            if (e = e || y, !h && A(a.watchId)) c = c || this.nextId(), this.if_("i", this.lazyAssign(c, this.computedMember("i", a.watchId)), this.lazyRecurse(a, c, d, e, f, !0)); else switch (a.type) {
              case s.Program:
              ...
              case s.UnaryExpression:
                this.recurse(a.argument, w, w, function(a) {
                    l = a;
                }), p = a.operator + "(" + this.ifDefined(l, 0) + ")", this.assign(c, p), e(p);
                break;
              ...
              case s.Identifier:
                ...
                d.computed = !1, d.name = a.name), Xa(a.name), k.if_("inputs" === k.stage || k.not(k.getHasOwnProperty("l", a.name)), function() {
              ...
              case s.MemberExpression:
                g = d && (d.context = this.nextId()) || this.nextId(), c = c || this.nextId(), k.recurse(a.object, g, w, function() {
                    k.if_(k.notNull(g), function() {
                        a.computed ? (l = k.nextId(), k.recurse(a.property, l), k.getStringValue(l), k.addEnsureSafeMemberName(l), 
                        ...
                        d.name = l)) : (Xa(a.property.name), f && 1 !== f && k.if_(k.not(k.nonComputedMember(g, a.property.name)), k.lazyAssign(k.nonComputedMember(g, a.property.name), "{}")), 
                        p = k.nonComputedMember(g, a.property.name), (k.state.expensiveChecks || Fb(a.property.name)) && (p = k.ensureSafeObject(p)), 
                        k.assign(c, p), d && (d.computed = !1, d.name = a.property.name));
                    }, function() {
              ...
              case s.CallExpression:
                ...
                n = [], k.recurse(a.callee, l, g, function() {
                    k.if_(k.notNull(l), function() {
                        ...
                        p = k.ensureSafeObject(p), k.assign(c, p);
                    }, function() {
                        k.assign(c, "undefined");
                    }), e(c);
                }));
              ...
              case s.AssignmentExpression:
                ...
                this.recurse(a.left, w, g, function() {
                    k.if_(k.notNull(g.context), function() {
                        k.recurse(a.right, l), k.addEnsureSafeObject(k.member(g.context, g.name, g.computed)), 
                        k.addEnsureSafeAssignContext(g.context), p = k.member(g.context, g.name, g.computed) + a.operator + l, 
                        k.assign(c, p), e(c || p);
                    });
                }, 1);
                break;
        ...
        compile: function(a, c) {
            var d = this, e = this.astBuilder.ast(a);
            this.expression = a, this.expensiveChecks = c, U(e, d.$filter);
            var f, h;
            (f = qd(e)) && (h = this.recurse(f)), f = od(e.body);
            var g;
            ...
            return m(e.body, function(a) {
                ...
                return h(a, d, c);
            }), g && (f.inputs = g), f.literal = rd(e), f.constant = e.constant, f;
        },
            ...
            switch (a.type) {
              ...
              case s.AssignmentExpression:
                return e = this.recurse(a.left, !0, 1), f = this.recurse(a.right), function(a, d, g, p) {
                    var r = e(a, d, g, p);
                    return a = f(a, d, g, p), Ba(r.value, h.expression), md(r.context), r.context[r.name] = a, 
                    c ? {
                        value: a
                    } : a;
                };
        ...
        "unary+": function(a, c) {
            return function(d, e, f, h) {
                return d = a(d, e, f, h), d = A(d) ? +d : 0, c ? {
                    value: d
                } : d;
            };
        },
        ...
        "binary-": function(a, c, d) {
            return function(e, f, h, g) {
                var l = a(e, f, h, g);
                return e = c(e, f, h, g), l = (A(l) ? l : 0) - (A(e) ? e : 0), d ? {
                    value: l
                } : l;
            };
        },
        "binary*": function(a, c, d) {
            return function(e, f, h, g) {
                return e = a(e, f, h, g) * c(e, f, h, g), d ? {
                    value: e
                } : e;
            };
        },
        ...
        "ternary?:": function(a, c, d, e) {
            return function(f, h, g, l) {
                return f = a(f, h, g, l) ? c(f, h, g, l) : d(f, h, g, l), e ? {
                    value: f
                } : f;
            };
        },
        ...
        identifier: function(a, c, d, e, f) {
            return function(h, g, l, k) {
                return h = g && a in g ? g : h, e && 1 !== e && h && !h[a] && (h[a] = {}), g = h ? h[a] : w, 
                c && Ba(g, f), d ? {
                    context: h,
                    name: a,
                    value: g
        ...
        computedMember: function(a, c, d, e, f) {
            return function(h, g, l, k) {
                var p, m, n = a(h, g, l, k);
                return null != n && (p = c(h, g, l, k), p = kd(p), Xa(p, f), e && 1 !== e && n && !n[p] && (n[p] = {}), 
                m = n[p], Ba(m, f)), d ? {
                    context: n,
                    name: p,
                    value: m
        ...
        nonComputedMember: function(a, c, d, e, f, h) {
            return function(g, l, k, n) {
                return g = a(g, l, k, n), f && 1 !== f && g && !g[c] && (g[c] = {}), l = null != g ? g[c] : w, 
                (d || Fb(c)) && Ba(l, h), e ? {
                    context: g,
                    name: c,
                    value: l
    ...
    var fc = function(a, c, d) {
        this.lexer = a, this.$filter = c, this.options = d, this.ast = new s(this.lexer), 
    ...
    yd.$inject = [ "$document" ], Kc.$inject = [ "$provide" ], zd.$inject = [ "$locale" ], 
    Bd.$inject = [ "$locale" ];
    var hc = ".", hg = {
        yyyy: aa("FullYear", 4),
    ...
    m(Bb, function(a, c) {
        ...
        tb[c] = function() {
            return {
                ...
                link: function(d, e, f) {
                    var h = a, g = a;
                    "href" === a && "[object SVGAnimatedString]" === va.call(e.prop("href")) && (g = "xlinkHref", 
                    f.$attr[g] = "xlink:href", h = null), f.$observe(c, function(c) {
    ...
    var Od = function(a) {
    ...
    }, ie = Od(), ve = Od(!0), ig = /\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z)/, sg = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, tg = /^[a-z0-9!#$%&'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$/i, ug = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, Pd = /^(\d{4})-(\d{2})-(\d{2})$/, Qd = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, lc = /^(\d{4})-W(\d\d)$/, Rd = /^(\d{4})-(\d\d)$/, Sd = /^(\d\d):(\d\d)(?::(\d\d)(\.\d{1,3})?)?$/, Td = {
        ...
        week: kb("week", lc, function(a, c) {
            ...
            if (G(a)) {
                ...
                if (d) {
                    ...
                    return c && (d = c.getHours(), h = c.getMinutes(), g = c.getSeconds(), l = c.getMilliseconds()), 
        ...
        number: function(a, c, d, e, f, h) {
            if (Id(a, c, d, e), jb(a, c, d, e, f, h), e.$$parserName = "number", e.$parsers.push(function(a) {
        ...
        return {
            compile: function(d) {
                return c.$$addBindingClass(d), function(d, f, h) {
                    d = a(f.attr(h.$attr.ngBindTemplate)), c.$$addBindingInfo(f, d.expressions), f = f[0], 
    ...
    var xe = [ "$animate", function(a) {
        return {
            ...
            link: function(c, d, e, f, h) {
                ...
                c.$watch(e.ngIf, function(c) {
                    c ? l || h(function(c, f) {
                        l = f, c[c.length++] = X.createComment(" end ngIf: " + e.ngIf + " "), g = {
                            clone: c
    ...
    }, mb = "ng-valid", Kd = "ng-invalid", Ya = "ng-pristine", Jb = "ng-dirty", Md = "ng-pending", lb = I("ngModel"), xg = [ "$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", "$rootScope", "$q", "$interpolate", function(a, c, d, e, f, h, g, l, k, n) {
        ...
        this.$valid = !0, this.$invalid = !1, this.$error = {}, this.$$success = {}, this.$pending = w, 
        this.$name = n(d.name || "", !1)(a), this.$$parentForm = Ib;
        var u, p = f(d.ngModel), r = p.assign, t = p, s = r, K = null, q = this;
        ...
        Hd({
            ...
            function e() {
                var d = !0;
                return m(q.$validators, function(e, f) {
                    var h = e(a, c);
                    d = d && h, g(f, h);
                }), d ? !0 : (m(q.$asyncValidators, function(a, c) {
                    g(c, null);
                }), !1);
            }
            function f() {
            ...
            (function() {
                ...
                return v(u) ? (g(a, null), !0) : (u || (m(q.$validators, function(a, c) {
                    g(c, null);
            ...
            var a = q.$viewValue;
            g.cancel(K), (q.$$lastCommittedViewValue !== a || "" === a && q.$$hasNativeValidators) && (q.$$lastCommittedViewValue = a, 
            q.$pristine && this.$setDirty(), this.$$parseAndValidate());
        }, this.$$parseAndValidate = function() {
            var c = q.$$lastCommittedViewValue;
            if (u = v(c) ? w : !0) for (var d = 0; d < q.$parsers.length; d++) if (c = q.$parsers[d](c), 
            v(c)) {
                u = !1;
                break;
            }
            ...
            q.$$rawModelValue = c, f && (q.$modelValue = c, q.$modelValue !== e && q.$$writeModelToScope()), 
        ...
        return {
            ...
            priority: 1,
            compile: function(c) {
                return c.addClass(Ya).addClass("ng-untouched").addClass(mb), {
                    pre: function(a, c, f, h) {
                        var g = h[0];
                        c = h[1] || g.$$parentForm, g.$$setOptions(h[2] && h[2].$options), c.$addControl(g), 
                    ...
                    post: function(c, e, f, h) {
                        var g = h[0];
                        g.$options && g.$options.updateOn && e.on(g.$options.updateOn, function(a) {
        ...
        return {
            ...
            controller: [ "$scope", "$attrs", function(a, c) {
                var d = this;
                this.$options = ha(a.$eval(c.ngModelOptions)), A(this.$options.updateOn) ? (this.$options.updateOnDefault = !1, 
        ...
        function d(a, d, e) {
            ...
            return {
                ...
                getOptions: function() {
                    for (var a = [], c = {}, d = H(e) || [], g = n(d), h = g.length, m = 0; h > m; m++) {
        ...
        return {
            ...
            link: function(c, g, l, k) {
                function n(a, c) {
                    a.element = c, c.disabled = a.disabled, a.label !== c.label && (c.label = a.label, 
                    c.textContent = a.label), a.value !== c.value && (c.value = a.selectValue);
                }
                function p(a, c, d, e) {
                    return c && F(c.nodeName) === d ? d = c : (d = e.cloneNode(!1), c ? a.insertBefore(d, c) : a.appendChild(d)), 
                    d;
                }
                function r(a) {
                ...
                function v() {
                    ...
                    if (O && g.prepend(q), d = s(d), x.items.forEach(function(a) {
                        var h, k;
                ...
                if (w) {
                    var u = k[0];
                    k = l.multiple;
                    for (var q, z = 0, y = g.children(), A = y.length; A > z; z++) if ("" === y[z].value) {
                        q = y.eq(z);
                        break;
                    }
                    ...
                    k ? (w.$isEmpty = function(a) {
                        ...
                        return J(w.$viewValue) ? w.$viewValue.map(function(a) {
                        ...
                        c && !c.disabled ? g[0].value !== c.selectValue && (H.remove(), O || q.remove(), 
                        g[0].value = c.selectValue, c.element.selected = !0, c.element.setAttribute("selected", "selected")) : null === a || O ? (H.remove(), 
                        O || g.prepend(q), g.val(""), q.prop("selected", !0), q.attr("selected", !0)) : (O || q.remove(), 
                        g.prepend(H), g.val("?"), H.prop("selected", !0), H.attr("selected", !0));
                    }, u.readValue = function() {
                    ...
                    v(), c.$watchCollection(C.getWatchables, v);
                }
            }
        };
        ...
        return {
            link: function(h, g, l) {
                ...
                var x, n = l.count, p = l.$attr.when && g.attr(l.$attr.when), r = l.offset || 0, s = h.$eval(p) || {}, w = {}, A = c.startSymbol(), u = c.endSymbol(), q = A + n + "-" + r + u, z = da.noop;
                m(l, function(a, c) {
                    var d = f.exec(c);
                    ...
                    f || e in s || (e = a.pluralCat(e - r)), e === x || f && V(x) && isNaN(x) || (z(), 
                    f = w[e], v(f) ? (null != c && d.debug("ngPluralize: no rule defined for '" + e + "' in " + p), 
                    z = y, k()) : z = h.$watch(f, k), x = e);
                });
            }
        };
            ...
            compile: function(f, h) {
                ...
                return s ? u = a(s) : (z = function(a, c) {
                    ...
                    a.$watchCollection(p, function(h) {
                        var k, p, u, C, G, J, M, I, F, L, t = f[0], x = fa();
                        if (r && (a[r] = h), Da(h)) I = h, p = q || z; else for (L in p = q || A, I = [], 
                        h) ta.call(h, L) && "$" !== L.charAt(0) && I.push(L);
                        for (C = I.length, L = Array(C), k = 0; C > k; k++) if (G = h === I ? k : I[k], 
                        J = h[G], M = p(G, J, k), s[M]) F = s[M], delete s[M], x[M] = F, L[k] = F; else {
                        ...
                        for (u in s) {
                            if (F = s[u], M = rb(F.clone), c.leave(M), M[0].parentNode) for (k = 0, p = M.length; p > k; k++) M[k].$$NG_REMOVED = !0;
                            F.scope.$destroy();
                        }
                        for (k = 0; C > k; k++) if (G = h === I ? k : I[k], J = h[G], F = L[k], F.scope) {
                            u = t;
                            do u = u.nextSibling; while (u && u.$$NG_REMOVED);
                            F.clone[0] != u && c.move(rb(F.clone), null, B(t)), t = F.clone[F.clone.length - 1], 
                            e(F.scope, k, v, J, y, G, C);
                        } else n(function(a, d) {
                            F.scope = d;
                            var f = l.cloneNode(!1);
                            a[a.length++] = f, c.enter(a, null, B(t)), t = f, F.clone = a, x[F.id] = F, e(F.scope, k, v, J, y, G, C);
                        });
                        s = x;
                    });
                };
                ...
                c.$watch(e.ngSwitch || e.on, function(c) {
                    ...
                    g.length = 0, k.length = 0, (h = f.cases["!" + c] || f.cases["?"]) && m(h, function(c) {
                        c.transclude(function(d, e) {
                            k.push(e);
                            var f = c.element;
                            d[d.length++] = X.createComment(" end ngSwitchWhen: "), g.push({
                                clone: d
        ...
        var e = this, f = new Ua();
        e.ngModelCtrl = Bg, e.unknownOption = B(X.createElement("option")), e.renderUnknownOption = function(c) {
        ...
        return {
            ...
            link: function(a, c, d, e) {
                ...
                if (f) {
                    var h = e[0];
                    if (h.ngModelCtrl = f, f.$render = function() {
            ...
            link: function(a, c, d, e) {
                if (e) {
                    ...
                    d.$observe("pattern", function(a) {
                        if (G(a) && 0 < a.length && (a = new RegExp("^" + a + "$")), a && !a.test) throw I("ngPattern")("noregexp", h, a, xa(c));
                        f = a || w, e.$validate();
    ...
    Q.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : (ce(), 
    ee(da), da.module("ngLocale", [], [ "$provide", function(a) {
        function c(a) {
            a += "";
            var c = a.indexOf(".");
        ...
        a.value("$locale", {
            ...
            pluralCat: function(a, e) {
                var f = 0 | a, h = e;
                return w === h && (h = Math.min(c(a), 3)), Math.pow(10, h), 1 == f && 0 == h ? "one" : "other";
            }
        });
    } ]), B(X).ready(function() {
        Zd(X, zc);
...
function(p, c, C) {
    ...
    function F(a, f) {
        function d(a, b, d, l) {
            if (b = h.lowercase(b), s[b]) for (;e.last() && t[e.last()]; ) c("", e.last());
            u[b] && e.last() == b && c("", b), (l = v[b] || !!l) || e.push(b);
            var m = {};
        ...
        function c(b, a) {
            var d, c = 0;
            if (a = h.lowercase(a)) for (c = e.length - 1; c >= 0 && e[c] != a; c--) ;
            if (c >= 0) {
        ...
        for (e.last = function() {
            ...
            if (l = "", k = !0, e.last() && w[e.last()] ? (a = a.replace(new RegExp("([\\W\\w]*)<\\s*\\/\\s*" + e.last() + "[^>]*>", "i"), function(a, b) {
                return b = b.replace(H, "$1").replace(I, "$1"), f.chars && f.chars(q(b)), "";
            }), c("", e.last())) : (0 === a.indexOf("<!--") ? (b = a.indexOf("--", 4), b >= 0 && a.lastIndexOf("-->", b) === b && (f.comment && f.comment(a.substring(4, b)), 
            ...
            b[0].replace(z, d)), k = !1) : (l += "<", a = a.substring(1))), k && (b = a.indexOf("<"), 
            l += 0 > b ? a : a.substring(0, b), a = 0 > b ? "" : a.substring(b), f.chars && f.chars(q(l)))), 
    ...
    function B(a) {
        return a.replace(/&/g, "&amp;").replace(M, function(a) {
            ...
            return a = a.charCodeAt(1), "&#" + (1024 * (d - 55296) + (a - 56320) + 65536) + ";";
    ...
    h.module("ngSanitize", []).provider("$sanitize", function() {
        ...
        return function(c, b) {
            ...
            p = m.index, k(l.substr(0, p)), e(n, m[0].replace(d, "")), l = l.substring(p + m[0].length);
            return k(l), a(g.join(""));
        };
    } ]);
}(window, window.angular), angular.module("oitozero.ngSweetAlert", []).factory("SweetAlert", [ "$rootScope", function($rootScope) {
...
var app = angular.module("iBuy", [ "ngRoute", "ngSanitize", "ibuy.services", "ibuy.controllers", "oitozero.ngSweetAlert" ]);

app.run([ "$rootScope", "$location", "authService", function($rootScope, $location, authService) {
    $rootScope.$on("$routeChangeStart", function(event, next, current) {
<<<<<<< HEAD
        next && "/login" == next.$$route.originalPath && authService.isAuthenticated() && $location.path("/items"), 
=======
>>>>>>> master
        next && next.$$route && next.$$route.secure && (authService.isAuthenticated() || $rootScope.$evalAsync(function() {
            $location.path("/login");
        }));
    });
    ...
    return {
        set: function(key, value) {
            "object" == typeof value ? $window.localStorage[key] = JSON.stringify(value) : $window.localStorage[key] = value;
        },
    ...
    return {
        ...
        changeWishilist: function(id_product, purchased) {
            var title = purchased ? "Comprado" : "Não comprado", text = purchased ? "Produto marcado como comprado" : "Produto marcado como não comprado";
        ...
        removeWishilist: function(id_product, hideConfirm) {
            var showConfirm = hideConfirm ? !1 : !0;
...
app.controller("LoginCtrl", [ "$scope", "authService", "SweetAlert", "$location", "$localstorage", function($scope, authService, SweetAlert, $location, $localstorage) {
    $scope.auth = {}, $scope.doLogIn = function() {
        $scope.disableButton = !0, authService.login($scope.auth).then(function(data) {
            var result = data.data;
            result && ($localstorage.set("user", result), $location.path("/items"));
        }, function(err) {
            $scope.disableButton = !1, 404 == err.status ? SweetAlert.swal("Erro", err.data, "error") : console.log("Error", err);
        });
    };
} ]), app.controller("RegisterCtrl", [ "$scope", "authService", "SweetAlert", "$location", "$localstorage", function($scope, authService, SweetAlert, $location, $localstorage) {
    $scope.auth = {}, $scope.doSignUp = function() {
        $scope.disableButton = !0, authService.signup($scope.auth).then(function(data) {
            var result = data.data;
            $localstorage.set("user", result), result && swal({
                title: "Parabéns!",
            ...
            $scope.disableButton = !1, SweetAlert.swal("Erro", err.data, "error");
        });
    };
} ]), app.controller("headerCtrl", [ "$scope", "$location", "authService", function($scope, $location, authService) {
    $scope.isActive = function(menu) {
        return $location.path() == menu;
    }, $scope.username = authService.getUser().name, $scope.doLogout = function() {
        authService.logout(), $location.path("/login");
    }, $scope.headerMobile = !1;
} ]), app.controller("ItemsCtrl", [ "$scope", "productsService", "wishilist", function($scope, productsService, wishilist) {
    $scope.items = [], productsService.getProducts().then(function(data) {
        var result = data.data;
        result && ($scope.items = result);
    }), $scope.addWishilist = function(item) {
        item.wishilist = !0, wishilist.addWishilist(item._id);
    };
} ]), app.controller("ItemDetailCtrl", [ "$scope", "productsService", "$route", "wishilist", function($scope, productsService, $route, wishilist) {
    $scope.item = {}, $scope.alias = $route.current.params.alias, productsService.getProduct($scope.alias).then(function(data) {
        var result = data.data;
        result && ($scope.item = result);
    }), $scope.addWishilist = function(id_product) {
        $scope.item.isWishilist = !0, wishilist.addWishilist(id_product);
    }, $scope.removeWishilist = function(id_product) {
        $scope.item.isWishilist = !1, wishilist.removeWishilist(id_product);
    };
} ]), app.controller("WishilistCtrl", [ "$scope", "wishilistService", "wishilist", function($scope, wishilistService, wishilist) {
    $scope.wishlist = [], wishilistService.getList().then(function(data) {
        var result = data.data;
        result && ($scope.wishlist = result);
    }, function(err) {
        SweetAlert.swal("Erro", err.data, "error");
    }), $scope.changePurchased = function(item) {
        item.purchased = !item.purchased, wishilist.changeWishilist(item._id, item.purchased);
    }, $scope.removeWishilist = function(item, $index) {
        wishilist.removeWishilist(item._id, !0), $scope.wishlist.splice($index, 1);
    };
} ]);

var app = angular.module("ibuy.services", []);

app.constant("API_URL", "https://protected-atoll-9121.herokuapp.com/"), app.service("authService", [ "$http", "$localstorage", "API_URL", function($http, $localstorage, API_URL) {
    return {
        getUser: function() {
            var user = $localstorage.get("user");
            return Object.keys(user).length ? user : !1;
        },
        isAuthenticated: function() {
            return this.getUser() ? !0 : !1;
        },
    ...
    return {
        ...
        addList: function(data) {
            var user = authService.getUser();
            return data.id_user = user._id, data.purchased = !1, $http.post(API_URL + "wishilist", data);
        },
        updateItemList: function(id_product, purchased) {
            var user = authService.getUser();
            return $http.put(API_URL + "wishilist/" + user._id + "/" + id_product, {
                id_user: user._id,
                id_product: id_product,
                purchased: purchased
            });
